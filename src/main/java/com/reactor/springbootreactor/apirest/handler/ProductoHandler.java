package com.reactor.springbootreactor.apirest.handler;
...
public class ProductoHandler {
    ...
    public Mono<ServerResponse> crearConFoto(ServerRequest request){
        ...
        Mono<Producto> producto = request.multipartData().map(multipart -> {
            ...
            FormFieldPart categoriaId = (FormFieldPart) multipart.toSingleValueMap().get("categirua.id");
            FormFieldPart categoriaNombre = (FormFieldPart) multipart.toSingleValueMap().get("categirua.nombre");
